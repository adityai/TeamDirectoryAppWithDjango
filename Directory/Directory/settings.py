...
SECRET_KEY = 'jwa550fd6-5ut4!ox3zbrzo@+cl4h$)**7nqd+slz*^f22o#iv'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social.apps.django_app.context_processors.backend',
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'www.view.verify_email',  # <--- set the path to the function
